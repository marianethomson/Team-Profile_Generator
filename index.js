...
function employee() {
  inquirer
    .prompt([
      { type: "input", name: "name", message: "What is the staff name?" },
      { type: "input", name: "id", message: "What is the staff id?" },
      { type: "input", name: "email", message: "What is the staff email?" },
    ])
    .then((answers) => {
